...
\begin{problem}
  ...
  \begin{enumerate}
    ...
    \item Какие из вероятностей можно посчитать без мнения Бориса о $\P(H_0)$ и $\P(H_a)$?
    \item Какая из вероятностей называется уровнем значимости теста? Частотой ложного отвержения нулевой гипотезы (FDR)?
  \end{enumerate}
...
\begin{sol}
Вектор $\nu^*$ ортогонален вектору $\sqrt{n}v$, где $v = (\sqrt{p_1}, \ldots, \sqrt{p_n})$ 
и $\nu_i^* = (\nu_i - np_i) / \sqrt{np_i}$.
\[
