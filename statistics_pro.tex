...
\[
I_1(\theta) = \Var(\partial \ln f(X_1) / \partial \theta) = \E((\partial \ln f(X_1) / \partial \theta)^2)= - \E(\partial^2 \ln f(X_1) / \partial \theta^2)
\]
Для независимых наблюдений $I_n(\theta) = nI_1(\theta)$.

Неравенство Рао~— Крамера
\[
\Var(\hat \theta) \geq \frac{(\Cov(\partial \ln f(X_1, \ldots, X_n) / \partial \theta, \hat\theta))^2}{I_n(\theta)} = \frac{(\partial \E(\hat\theta) / \partial \theta)^2}{I_n(\theta)}
\]
\end{leftbar}
...
Рассмотрим величины $S_i = \partial \ln f(X_i) / \partial \theta$. 
...
\begin{enumerate}
  ...
  \item Какие значения с какими вероятностями принимает величина $\partial S_1/\partial \theta$?
  \item Найдите $\E(\partial S_1/\partial \theta)$.
...
\begin{problem}
  ...
  \begin{enumerate}
    ...
    \item Найдите $\E(S_1)$, $\E(S_1^2)$, $\Var(S_1)$.
    \item Какие значения принимает величина $\partial S_1/\partial \theta$?
    \item Найдите $\E(\partial S_1/\partial \theta)$.
